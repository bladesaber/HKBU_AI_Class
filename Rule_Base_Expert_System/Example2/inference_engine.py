import re
from Rule_Base_Expert_System.Example2.basic_rule import Rule
rules_filepath = 'D:\HKBU_AI_Classs\Rule_Base_Expert_System\Example2/rules.txt'
